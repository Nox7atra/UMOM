...
Shader "Custom/SuperBlur"
{
 ...
 {
     fixed4 sum = tex2D(_MainTex, IN.texcoord)* 0.29411764;
     sum += tex2D(_MainTex, IN.blurTexcoord.xy) * 0.35294117;
     sum += tex2D(_MainTex, IN.blurTexcoord.zw) * 0.35294117;
     return sum;
 }
 ...
 {
     fixed4 sum = tex2D(_MainTex, IN.texcoord) * 0.22702702;
     sum += tex2D(_MainTex, IN.blurTexcoord[0].xy) * 0.31621621;
     sum += tex2D(_MainTex, IN.blurTexcoord[0].zw) * 0.31621621;
     sum += tex2D(_MainTex, IN.blurTexcoord[1].xy) * 0.07027027;
     sum += tex2D(_MainTex, IN.blurTexcoord[1].zw) * 0.07027027;
     return sum;
 }
 ...
 {
     fixed4 sum = tex2D(_MainTex, IN.texcoord) * 0.19648255;
     sum += tex2D(_MainTex, IN.blurTexcoord[0].xy) * 0.29690696;
     sum += tex2D(_MainTex, IN.blurTexcoord[0].zw) * 0.29690696;
     sum += tex2D(_MainTex, IN.blurTexcoord[1].xy) * 0.09447039;
     sum += tex2D(_MainTex, IN.blurTexcoord[1].zw) * 0.09447039;
     sum += tex2D(_MainTex, IN.blurTexcoord[2].xy) * 0.01038136;
     sum += tex2D(_MainTex, IN.blurTexcoord[2].zw) * 0.01038136;
     return sum;
 }
